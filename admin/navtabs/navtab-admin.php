  ...
  <div class="container">
    ...
    <nav class="navbar bg-body-tertiary">
      <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <!--Admin-->
          <li class="nav-item" role="presentation">
            <a class="nav-link active" style="color: black; text-decoration: none;" href="admin.php">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mt-3 mb-lg-0">
        <small><p><?=htmlspecialchars($_SESSION['fname']); ?> <?=htmlspecialchars($_SESSION['lname']); ?></p></small>
      </ul>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropstart">
            <ul class="dropdown-menu">
              ...
              <li ><a class="dropdown-item" href="profile.php"><small>Profile</small></a></li>
              <li><hr class="dropdown-divider" /></li>
              <li><a class="dropdown-item" href="/HC/logout-process.php"><small>Logout</small></a></li>
            </ul>
          </div>
        </li>
      </ul>
