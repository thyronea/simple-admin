    ...
    <nav class="navbar bg-body-tertiary">
      <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <!--Calendar-->
          <li class="nav-item" role="presentation">
            <a class="nav-link active" style="color: black; text-decoration: none;" href="calendar.php">
          ...
          <!--Admin-->
          <li class="nav-item" role="presentation">
            <a class="nav-link" style="color: black; text-decoration: none;" href="admin.php" value="<?php if(isset($_GET['manage-admin'])){echo $_GET['']; }?>">
