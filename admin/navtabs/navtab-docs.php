    ...
    <nav class="navbar bg-body-tertiary">
      <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <!--Patients-->
          <li class="nav-item" role="presentation">
            <a class="nav-link" <a style="color: black; text-decoration: none;" href="patients.php">
          ...
          <!--Documents-->
          <li class="nav-item" role="presentation">
            <a class="nav-link active" style="color: black; text-decoration: none;" href="docs.php">
