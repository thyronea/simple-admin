<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container">
    ...
    <!--Contents will show in admin/components/body.php and can be configured by page in admin/pages-->
    <nav class="navbar bg-body-tertiary">
      <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <!--Patients-->
          <li class="nav-item" role="presentation">
            <a class="nav-link active" <a style="color: black; text-decoration: none;" href="patients.php">
          ...
          <!--Calendar-->
          <li class="nav-item" role="presentation">
            <a class="nav-link" style="color: black; text-decoration: none;" href="calendar.php">
          ...
          <!--Immunization-->
          <li class="nav-item" role="presentation">
            <a class="nav-link" style="color: black; text-decoration: none;" href="immunization.php">
          ...
          <li class="nav-item" role="presentation">
            <a class="nav-link" style="color: black; text-decoration: none;" href="thermometer.php">
          ...
          <!--Documents-->
          <li class="nav-item" role="presentation">
            <a class="nav-link" style="color: black; text-decoration: none;" href="docs.php">
          ...
          <!--Admin-->
          <li class="nav-item" role="presentation" value="<?php if(isset($_GET['manage-admin'])){echo $_GET['']; }?>">
            <a class="nav-link" style="color: black; text-decoration: none;" href="admin.php">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mt-1 mb-lg-0">
        <small><?=htmlspecialchars($_SESSION['fname']); ?> <?=htmlspecialchars($_SESSION['lname']); ?></small>
      </ul>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropstart">
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="/HC/logout-process.php">Logout</a></li>
            </ul>
          </div>
        </li>
      </ul>
